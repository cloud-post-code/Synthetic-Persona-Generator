/** Discriminated union returned by POST /api/voice/intent and executed by VoiceAgentProvider */
...
export type RouteSpec = {
  ...
  /** allowed query keys and optional enum values per key */
  query?: Record<string, string[]>;
};

export type VoiceTargetAction = 'click' | 'focus' | 'fill';
