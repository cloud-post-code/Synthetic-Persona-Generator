...
export const GENERATED_UI_SEMANTICS: UiSemanticsCorpus = {
  "hash": "e928e14057a2b2630c1f68014556cdcd0d5cfa14890187d459aa5c9ed80e1e63",
  "generatedAt": "2026-05-03T02:07:14.791Z",
  "docs": [
    {
      "type": "ui_node",
      "id": "auth.login",
    ...
    },
    {
      ...
      "body": "# Form build.persona.assistant\n\nTitle: Build persona — voice assistant\nPage: /build\nPurpose: Voice-first: tap the mic to describe what you need, tap again to route to Synthetic user or Advisor and fill fields.\n\n\n\n## Fields (target ids)\n- build.persona.assistant.mic_toggle | label=\"Tap to speak your persona; tap again to build from what you said\" type=button action=click\n"
    },
    {
      "type": "form_schema",
      "id": "login",
